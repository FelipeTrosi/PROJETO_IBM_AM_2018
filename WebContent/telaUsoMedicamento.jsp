...
%>
  ...
  <head>
    ...
    <script type="text/javascript" src="js/validarCadastroUsoMedicamento2.js"></script>
                  ...
                  <i class="fas fa-pills"></i>
                    ...
                    Opções
                  	...
                  	<div class="dropdown-menu" aria-labelledby="dropDown" style="margin-left: -150px;">
    								...
    								<a class="dropdown-item" href="cadastroMedicamento.jsp">Cadastrar o uso medicamento</a>
      ...
      <div class="container mt-5">
        <div class="content">
              ...
              <form class="tabelaPaciente">
					<div style="overflow-x:auto; height:400px;">
						<table>
							...
							<c:forEach var="registroUsoMedicamentos" items="${sessaoListaUsoMedicamento}">
							<tr>
								<td>${registroUsoMedicamentos['codigo']}</td>
								<td>${registroUsoMedicamentos['usuario'].codigo}</td>
								<td>${registroUsoMedicamentos['usuario'].nome}</td>
								<td>${registroUsoMedicamentos['medicamento'].codigo}</td>	
								<td>${registroUsoMedicamentos['medicamento'].nomeMedicamento}</td>						
								<td >${registroUsoMedicamentos['dataInicio']}</td>
								<td>${registroUsoMedicamentos['dataTermino']}</td>
            ...
            <div class="container col-md-5 mt-5">
              ...
              <form method="POST" name="formusomedicamento" >
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" id="inputEmail3" placeholder="Código do Medicamento" name="codUsoMed">
                  </div>
                </div>
                ...
                <div class="form-group row mt-5" style="margin-bottom:4px;">
                  <div class="col-sm-12">
                    <input onclick="return validar_cadastro_usomedicamento()" type="submit" class="btn btn-warning btn-block" value="Atualizar" formaction="AtualizarUsoMedicamento"  />
                  	<input type="submit" class="btn btn-warning btn-block" value="Deletar" formaction="ExcluirUsoMedicamento" style="background-color:#ff3333; color:white;" />
                  </div>
                </div>
