      ...
      <div class="container mt-5">
        <div class="content">
            <div class="content-left" >
              <img class="img-home1337"src="img/feature-cognitive_0_0.png" >
            </div>
            <div class="container col-md-5 mt-5" >
              ...
              <form method="POST" action="CadastroLembrete" name="formlembrete">
                ...
                <div class="form-group row" style="margin-bottom:5px;">
                  <label for="inputEmail3" class="col-sm-3 col-form-label"style="font-size:14px; padding:0;">Quantidade lembrete:</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group row" style="margin-bottom:4px;">
                 ...
                 <div class="form-group row mt-5" style="margin-bottom:4px;">
                  <div class="col-sm-12">
                    <input onclick="return validar_cadastro_lembrete()" type="submit" value="Cadastrar" class="btn btn-info btn-block"  />
                  </div>
                </div>
